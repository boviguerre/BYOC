...
$(function () {
    ...
    var git = {
        backgroundpos: 'backgroundpos', bookmark: 'bookmark', calculator: 'calculator',
    ...
    donate.click(function () {
        ...
        donations.css({
            left: dOffset.left + donate.outerWidth() - donations.outerWidth(),
    ...
    crosslink.click(function () {
        ...
        crosslinks.css({
            left: cOffset.left + crosslink.outerWidth() - crosslinks.outerWidth(),
    ...
    if ($.fn.bookmark) {
        $('#bookmark').bookmark({
            compact: true, popup: true, icons: 'img/bookmarks.png',
...
function showRating(name, id, prefix) {
    return;
    var rating = {
        backgroundpos: [0.0, 0], bookmark: [4.0, 9],
