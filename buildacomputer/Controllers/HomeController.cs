...
namespace buildacomputer.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                motherboards.Add("String!");
                processors.Add("String!");
                memories.Add("String!");
                hardDrives.Add("String!");
                soundCards.Add("String!");
                videoAdapters.Add("String!");
                opticalDrives.Add("String!");
                powerSupplies.Add("String!");
                computerCases.Add("String!");
            }
